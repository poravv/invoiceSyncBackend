        ...
        try:
            ...
            for inv in invoices:
                ...
                ascont_rows.append({
                    ...
                    "tipo_cambio": float(inv.tipo_cambio) if str(getattr(inv, "moneda","")).upper() in {"USD","DOLLAR","DÓLAR"} and getattr(inv, "tipo_cambio", None) else 1.0,
                    "ruc_cliente": inv.ruc_cliente or "",
                    "razon_cliente": inv.nombre_cliente or "",
                    "CDC": formatear_cdc(inv.cdc),
                    "email_origen": formatear_email_origen(getattr(inv, "email_origen", "")),
